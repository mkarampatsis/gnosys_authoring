...
var _brythonRunnerWorker = _interopRequireDefault(
  require('!!raw-loader!./brython-runner.worker.js')
);

var _brython = _interopRequireDefault(
  require('!!raw-loader!brython/brython.js')
);

var _brython_stdlib = _interopRequireDefault(
  require('!!raw-loader!brython/brython_stdlib.js')
);

var _stdio = _interopRequireDefault(
  require('!!raw-loader!../scripts/stdio.py')
);

var _sleep = _interopRequireDefault(
  require('!!raw-loader!../scripts/sleep.py')
);

var _fileio = _interopRequireDefault(
  require('!!raw-loader!../scripts/fileio.py')
);
  ...
  (0, _createClass2['default'])(BrythonRunner, [
    {
      ...
      value: function setParamValues(params) {
        ...
        for (
          var _i = 0, _Object$keys = Object.keys(values);
    ...
    },
    {
      key: 'handleMessage',
      value: (function () {
        var _handleMessage = (0, _asyncToGenerator2['default'])(
          /*#__PURE__*/ _regenerator['default'].mark(function _callee2(msg) {
            var data;
                ...
                while (1) {
                  switch ((_context2.prev = _context2.next)) {
                    case 0:
                      ...
                      _context2.next =
                        _context2.t0 === 'brython.init'
                          ? 3
                          : _context2.t0 === 'done'
                          ? 5
                          : _context2.t0 === 'stdout.write'
                          ? 8
                          : _context2.t0 === 'stdout.flush'
                          ? 10
                          : _context2.t0 === 'stderr.write'
                          ? 12
                          : _context2.t0 === 'stderr.flush'
                          ? 14
                          : _context2.t0 === 'stdin.readline'
                          ? 16
                          : _context2.t0 === 'file.update'
                          ? 23
                          : 26;
                      break;
    ...
    },
    {
      ...
      value: function writeInputData(key, data) {
        ...
        xhr.open(
          'POST',
          ''.concat(this.hangerUrl, '/').concat(key, '/write/'),
          true
        );
        ...
        xhr.onload = function (e) {
          if (xhr.readyState === 4) {
            if (xhr.status === 200) {
              ...
              console.error(
                'Failed to send input data via server tunnel.',
                xhr.statusText
              );
            }
          }
